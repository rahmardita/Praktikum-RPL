...
public class ParkiranGUI extends JFrame {
    ...
    private ModelTabelParkiran tabelModel;
    ...
    public ParkiranGUI(ParkiranController parkiranController) {
        ...
        tabelModel = new ModelTabelParkiran(new ArrayList<>());
        parkiranTable = new JTable(tabelModel);
    ...
    private void updateTableData() {
        ...
        tabelModel.setParkiranList(updatedData);
    }
